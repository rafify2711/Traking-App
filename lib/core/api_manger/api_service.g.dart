...
class _ApiService implements ApiService {
  ...
  @override
  Future<OtpResponse> verifyResetCode(OtpRequest otpRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<ApplyResponse> apply(FormData formData) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<GetAllVehiclesResponse> getAllVehicles() async {
    ...
    final _options = _setStreamType<GetAllVehiclesResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetAllVehiclesResponse _value;
    try {
      _value = GetAllVehiclesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<UserResponse> editProfile(UpdatedUserModel user) async {
    ...
    try {
      _value = UserResponse.fromJson(_result.data.toString());
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
